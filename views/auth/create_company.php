...
<div class="auth-wrapper">
    <div class="auth-card">
        ...
        <?php endif; ?>
        <form id="create_company_form"  method="POST" action="<?= BASE_URL ?>/create-company">
            ...
            <button type="submit" id="create_company_submit_btn" class="btn btn-primary w-100 mt-2">Create Workspace</button>
...
document.querySelector('#create_company_form').addEventListener('submit', function() {
    const btn = document.getElementById ('create_company_submit_btn')
    btn.disabled = true;
